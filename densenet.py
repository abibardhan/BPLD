...
from tensorflow.keras.applications import DenseNet121  # Import DenseNet
...
img_size = (150, 150)  # Ensure this matches the input size for DenseNet
batch_size = 32
...
# Load DenseNet base model, with pre-trained ImageNet weights
densenet_base = DenseNet121(weights='imagenet', include_top=False, input_shape=(img_size[0], img_size[1], 3))

# Freeze the DenseNet base model
densenet_base.trainable = False

# Build the model
model = models.Sequential([
    densenet_base,  # Use the pre-trained DenseNet121 base
...
# Save the model
model.save('densenet121_finetuned_model.keras')
